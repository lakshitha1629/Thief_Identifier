...
function gotResults(error, results) {
  ...
  label = results[0].label+" "+results[0].confidence+" | "+results[1].label+" "+results[1].confidence;
    ...
    if(results[0].label=="Incorrect"){
      bar1.html("<div class=\"container\"><h2 class=\"text-danger\">The Gap between buttons are incorrect.</h2></div><br>");
     
    }else{
      bar1.html("<div class=\"container\"><h2 class=\"text-success\">The Gap between buttons are Correct.</h2></div><br>");
